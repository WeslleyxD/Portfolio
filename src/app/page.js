            ...
            <header className={styles.header}>
              ...
              <div data-aos="fade-up" data-aos-delay="700" className={styles.links}>
                ...
                <Link href="cv.pdf" target='_blank'>
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-cv" viewBox="0 0 24 24" width="40" height="40" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
