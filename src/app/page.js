          ...
          <section>
            <header className={styles.header}>
              ...
              <div className={styles.options}>
                <ul data-aos="zoom-in" data-aos-delay="400">
              ...
              <div data-aos="fade-up" data-aos-delay="400" className={styles.links}>
            ...
            <aside className={styles.main}>
              <div ref={aboutRef} id="about" className={styles.about} data-aos="fade-down" data-aos-delay="400">
              ...
              <div ref={tecnologiesRef} className={styles.technologies} id="technologies" data-aos="fade-up" data-aos-delay="400">
                <div className={styles.hidden}>
                ...
                <div className={styles.images}>
                  ...
                  <div className={styles.icon}>
                    <Image src="/html5.svg" alt="html6" width="64" height="64" title="Html" />
                    <h6>HTML</h6>
                  </div>
                  <div className={styles.icon}>
                ...
                <div className={styles.images}>
                  ...
                  <div className={styles.icon}>
                    ...
                    <h6>Simple Queue Service(SQS)</h6>
                  </div>
                  <div className={styles.icon}>
                  ...
                  <div className={styles.icon}>
                    ...
                    <h6>Simple Storage Service(S3)</h6>
                  </div>
                  <div className={styles.icon}>
              ...
              <div ref={certifiedsRef} id='certifieds' className={styles.experiences} data-aos="fade-up" data-aos-delay="400">
                <div className={styles.hidden}>
              ...
              <footer style={{ marginTop: "5rem", textAlign: "center"}} >
                <p>&copy; 2023 Weslley Silva | Todos direitos reservados.</p>
              </footer>
